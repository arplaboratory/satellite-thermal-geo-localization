...
# bing + bing
python h5_transformer.py --database_name satellite --database_index 0 --queries_name satellite --queries_index 0 --compress --train_sample_num 40000 --val_sample_num 20000 --region_num 3
