...
python3 eval.py --resume='logs/default/'$1'/best_model.pth' --dataset_name=satellite_0_foxtechmapping_0 --datasets_folder ./datasets --infer_batch_size 256 --prior_location_threshold=512 --use_faiss_gpu --use_best_n=3

python3 eval.py --resume='logs/default/'$1'/best_model.pth' --dataset_name=satellite_0_foxtechmapping_0 --datasets_folder ./datasets --infer_batch_size 256 --prior_location_threshold=512 --use_faiss_gpu --use_best_n=2

python3 eval.py --resume='logs/default/'$1'/best_model.pth' --dataset_name=satellite_0_foxtechmapping_0 --datasets_folder ./datasets --infer_batch_size 256 --prior_location_threshold=512 --use_faiss_gpu --use_best_n=1
